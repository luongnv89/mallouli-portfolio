// Content mirrored from https://www.mallouli.com/
...
export const PUBLICATIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        authors: 'Assia Belbachir, Antonio M. Ortiz, Ahmed Nabil Belbachir, Wissam Mallouli, An Ngoc Lam, Akhilesh Kumar Srivastava, Martin Hemmer',
        title: 'COGNIMAN Digital Twin Architecture for Flexible Manufacturing.',
        venue: 'Journal of Intelligent Manufacturing. Published 12 June 2025.',
        doi: 'https://doi.org/10.1007/s10845-025-02625-1',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      {
        authors: 'George Amponis, Panagiotis I. Radoglou-Grammatikis, Thomas Lagkas, Wissam Mallouli, Ana R. Cavalli, Dimitrios Klonidis, Evangelos Markakis, Panagiotis G. Sarigiannidis',
        title: 'Threatening the 5G core via PFCP DoS attacks: the case of blocking UAV communications.',
        venue: 'EURASIP Journal on Wireless Communications and Networking, 2022(1): 124.',
        doi: 'https://doi.org/10.1186/s13638-022-02204-5',
      },
      {
      ...
      {
        authors: 'Arash Bozorgchenani, Charilaos C. Zarakovitis, Su Fong Chien, Heng Siong Lim, Qiang Ni, Antonios Gouglidis, Wissam Mallouli',
        title: 'Joint Security-vs-QoS framework: Optimizing the selection of intrusion detection mechanisms in 5G networks.',
        venue: 'ARES 2022, pp. 67:1–67:6, Vienna, Austria. August 23–26, 2022.',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        authors: 'Tan Nguyen, Hoang-Long Mai, Remi Cogranne, Guillaume Doyen, Wissam Mallouli, Luong Nguyen, Moustapha El Aoun, Edgardo Montes de Oca, Olivier Festor',
        title: 'Reliable Detection of Interest Flooding Attack in Real Deployment of Named Data Networking.',
        venue: 'IEEE Transactions on Information Forensics and Security, Vol. 14, Issue 9, pp. 2470–2485. September 2019.',
        doi: 'https://doi.org/10.1109/TIFS.2019.2899247',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        authors: 'Pamela Carvallo, Ana R. Cavalli, Wissam Mallouli, Erkuden Rios',
        title: 'Multi-cloud Applications Security Monitoring.',
        venue: 'CS3M @ GPC 2017, pp. 748–758, Cetara, Amalfi Coast, Italy. May 12, 2017.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      {
        authors: 'Edgardo Montes de Oca, Wissam Mallouli',
        title: 'Security aspects of SDMN.',
        venue: 'Software Defined Mobile Networks (SDMN): Beyond LTE Network Architecture. ISBN 978-1118900284. 17 August 2015.',
      },
      {
  ...
  },
  {
    ...
    items: [
      {
        authors: 'Wissam Mallouli',
        title: 'Passive testing for security checking using MMT.',
        venue: 'SASSI 2013, TU Berlin. September 19–20, 2013.',
      },
      {
        authors: 'Wissam Mallouli',
  ...
  },
  {
    ...
    items: [
      ...
      {
        authors: 'Wissam Mallouli, Amel Mammar, Ana Rosa Cavalli',
        title: 'Prise en Compte de Règles de Sécurité Temporelles dans une Spécification TEFSM d\'un Système.',
        venue: 'CFIP 2009, Strasbourg, France. October 12–15, 2009.',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        authors: 'Bachar Wehbi, Anis Laouiti, Wissam Mallouli, Ana Rosa Cavalli',
        title: 'Un Mécanisme de Synchronisation pour les Réseaux Sans Fil Multi-Sauts.',
        venue: 'NOTERE 2007, Marrakech, Morocco. June 4–8, 2007.',
      },
    ],
  },
  {
...
export const TEACHING = [
  {
    year: '2017–2018',
    items: [
      { what: 'Java', where: 'ESME Sudria — Master 2 MS', meta: '20 hours' },
      { what: 'Javascript', where: 'ESME Sudria — Master 2 MS', meta: '20 hours' },
      { what: 'Protocol Engineering', where: 'Université Paris VII Diderot — Master 2 SRI', meta: '6 hours' },
      { what: 'Java', where: 'ESME Sudria — Master 2 3BR Electronics/Telecoms', meta: '20 hours' },
      { what: 'Network traffic analysis based on DPI', where: 'ESME Sudria — Master 2 3BR', meta: '28 hours' },
    ],
  },
  {
    year: '2016–2017',
    items: [
      { what: 'Java', where: 'ESME Sudria — Master 2 MS', meta: '16 hours' },
      { what: 'Javascript', where: 'ESME Sudria — Master 2 MS', meta: '16 hours' },
      { what: 'Network traffic analysis based on DPI', where: 'ESME Sudria — Master 2 3BR', meta: '24 hours' },
      { what: 'Conception de protocoles réseaux', where: 'ESME Sudria — Master 2 3BR IT/Networks', meta: '4+12 hours' },
      { what: 'Protocol Engineering', where: 'Université Paris VII Diderot — Master 2 SRI', meta: '6 hours' },
      { what: 'Java', where: 'ESME Sudria — Master 2 3BR', meta: '20 hours' },
    ],
  },
  {
    year: '2015–2016',
    items: [
      { what: 'Conception de protocoles réseaux', where: 'ESME Sudria — Master 2 A2R/A3R', meta: '12+4+4+4+4 hours' },
      { what: 'Passive testing', where: 'Genopole — Master 2 Biology (mSSB)', meta: '6 hours' },
      { what: 'Ingénierie des protocoles', where: 'Université Paris VII Diderot — Master 2 SRI', meta: '6+3 hours' },
      { what: 'Deep Packet Inspection (supervision)', where: 'ESME Sudria — Master 2 B', meta: '30 hours' },
    ],
  },
  {
    year: '2014–2015',
    items: [
      { what: 'Conception de protocoles réseaux', where: 'ESME Sudria — Master 2 B', meta: '12+4+4 hours' },
      { what: 'Ingénierie des protocoles', where: 'Université Paris VII Diderot — Master 2 SRI', meta: '6+3 hours' },
      { what: 'Passive testing', where: 'Genopole — Master 2 Biology', meta: '6 hours' },
    ],
  },
  {
    year: '2013–2014',
  ...
  },
  {
    year: '2012–2013',
    items: [
      { what: 'Conception de protocoles réseaux', where: 'ESME Sudria — Master 2 BR', meta: '10+4 hours' },
      { what: 'Ingénierie des protocoles', where: 'Université Paris VII Diderot — Master 2 SRI', meta: '9+3 hours' },
    ],
  },
  {
    year: '2011–2012',
    items: [
      { what: 'Conception de protocoles réseaux', where: 'ESME Sudria — Master 2 B', meta: '9+12 hours' },
      { what: 'Passive Testing of Communicating Systems', where: 'Télécom & Management SudParis — Master', meta: '3 hours' },
      { what: 'Database Management', where: 'Télécom & Management SudParis — 2nd year', meta: '9 hours' },
      { what: 'Ingénierie des protocoles', where: 'Université Paris VII Diderot — Master 2', meta: '3 hours' },
    ],
  },
  {
    year: '2010–2011',
    items: [
      { what: 'Database Management', where: 'Télécom & Management SudParis', meta: '12 hours' },
      { what: 'Conception de protocoles réseaux', where: 'ESME Sudria — Master 2 B', meta: '9+12 hours' },
      { what: 'Bases de données', where: 'Université Paris I Panthéon-Sorbonne — L3', meta: '72 hours' },
      { what: 'Passive Testing of Communicating Systems', where: 'Télécom & Management SudParis', meta: '3 hours' },
      { what: 'Ingénierie des protocoles', where: 'Université Paris VII Diderot', meta: '3 hours' },
    ],
  },
  {
    year: '2009–2010',
    items: [
      { what: 'Conception de protocoles réseaux', where: 'ESME Sudria — Master 2 B', meta: '9 hours' },
      { what: 'Passive Testing of Communicating Systems', where: 'Télécom & Management SudParis', meta: '3 hours' },
      { what: 'Ingénierie des protocoles', where: 'Université Paris VII Diderot', meta: '3 hours' },
    ],
  },
  ...
  },
  {
    year: '2007–2008',
    items: [
      { what: 'Bureautique', where: 'Université d\'Évry Val d\'Essonne — L2 LEA', meta: '36 hours' },
      { what: 'Ingénierie des protocoles', where: 'Université Paris VII — Master 2 Pro', meta: '3 hours' },
      { what: 'Network Security', where: 'Université d\'Évry — Master 2 ASR', meta: '9 hours' },
      { what: 'Algorithmics', where: 'Université d\'Évry — L3 Mathematics', meta: '21 hours' },
    ],
  },
  {
    year: '2006–2007',
    items: [
      { what: 'Bureautique', where: 'Université d\'Évry — L1 AES', meta: '15 hours' },
      { what: 'Bureautique', where: 'Université d\'Évry — L2 LEA', meta: '18 hours' },
      { what: 'Performance Tuning and Analysis', where: 'Université d\'Évry — Master 2 ASR', meta: '9 hours' },
      { what: 'Network Security', where: 'Université d\'Évry — Master 2 ASR', meta: '9 hours' },
      { what: 'Advanced Networks', where: 'Université d\'Évry — Master 2 ASR', meta: '9 hours' },
    ],
  },
  {
    year: '2005–2006',
    items: [
      { what: 'Database courses & labs', where: 'Université d\'Évry — Master 1 MSG', meta: '30 hours' },
      { what: 'Advanced Databases (tutoring)', where: 'Université d\'Évry — Master 1', meta: '19 hours' },
      { what: 'Object Modeling (tutoring)', where: 'Université d\'Évry — Master 1', meta: '19 hours' },
      { what: 'Information Systems Analysis & Design', where: 'IIE — 2nd year Engineering', meta: '33 hours' },
      { what: 'Final Project (tutoring)', where: 'INT — 3rd year Engineering', meta: '10 hours' },
      { what: 'Network Security', where: 'Université d\'Évry — Master 2 ASR', meta: '6 hours' },
      { what: 'Network Administration', where: 'Université d\'Évry — Master 1', meta: '6 hours' },
    ],
  },
]

export const SUMMER_SCHOOLS = [
  { name: 'TAROT 2017', where: 'Naples, Italy · June 25–30', role: 'Organizer + Speaker' },
  { name: 'TAROT 2016', where: 'Porto, Portugal · July 4–8', role: 'Organizer + Speaker' },
  { name: 'TAROT 2015', where: 'Porto, Portugal · June 29 – July 2', role: 'Speaker' },
  { name: 'TAROT 2014', where: 'Porto, Portugal · June 30 – July 4', role: 'Speaker' },
  { name: 'TAROT 2013', where: 'Volterra, Italy · July 9–13', role: 'Speaker' },
  { name: 'TAROT 2012', where: 'Besançon / Métabief, France · July 2–6', role: 'Speaker' },
  { name: 'TAROT 2011', where: 'St Petersburg, Russia · June 27 – July 1', role: 'Attendee' },
  { name: 'TAROT 2009', where: 'Las Navas del Marqués, Spain · July 6–10', role: 'Speaker' },
  { name: 'TAROT 2008', where: 'Bath, UK · June 22–27', role: 'Speaker' },
  { name: 'TAROT 2007', where: 'Grenoble, France · July 2–6', role: 'Attendee' },
  { name: 'RESCOM 2007', where: 'Ajaccio, France · June 16–23', role: 'Attendee' },
  { name: 'TAROT 2005', where: 'Paris, France · June 27 – July 1', role: 'Attendee' },
]
...
export const PROJECTS = [
  {
    year: '2017',
    items: [
      { name: 'MoNet', desc: 'Deployment of the MMT monitoring tool to detect functional and security anomalies in the control and data planes of Softfire platforms.', dates: '2017-11-15 → 2018-02-15' },
      { name: 'SAINT', desc: 'Examines incentives for collaboration between cooperative and regulatory approaches to cybersecurity information sharing; develops business models for combating cybercrime.', dates: '2017-05-01 → 2019-04-30' },
      { name: 'ANASTACIA', program: 'H2020', desc: 'Researches, develops and demonstrates a holistic solution enabling trust and security by-design for Cyber Physical Systems based on IoT and Cloud architectures.', dates: '2017-01-01 → 2019-12-31' },
    ],
  },
  {
    year: '2015',
    items: [
      { name: 'MEASURE', program: 'ITEA3', desc: 'Enhancing software engineering quality and efficiency through automated continuous measurement tools; industrialization of the MMT solution with advanced analytics.', dates: '2015-12-01 → 2019-02-28' },
      { name: 'CLARUS', desc: 'A secure framework for the storage and processing of data outsourced to the cloud, enhancing trust in cloud computing services.', dates: '2015-01-01 → 2017-12-31' },
      { name: 'MUSA', desc: 'Security-intelligent lifecycle management of distributed applications across heterogeneous cloud resources, with security-by-design and integrated assurance methods.', dates: '2015-01-01 → 2017-12-31' },
    ],
  },
  {
    year: '2014',
    items: [
      { name: 'DOCTOR', desc: 'Monitoring of network stacks in virtualized environments under NFV — what to monitor, how to collect, and how to analyse and correlate.', dates: '2014-10-01 → 2018-03-31' },
    ],
  },
  {
    year: '2013',
    items: [
      { name: 'FI-PPP', program: 'European PPP', desc: 'European programme for Internet-enabled innovation accelerating Future Internet technologies.', dates: '2013-11-01 → 2013-12-31' },
      { name: 'SWEPT', program: 'CIP', desc: 'Security solution combining cost-effective security mechanisms and tools for automatically mitigating web site attacks.', dates: '2013-11-01 → 2016-10-30' },
      { name: 'SIGMONA', program: 'CELTIC+', desc: 'Network architectures for LTE/EPC mobile evolution using SDN, virtualization and cloud computing — performance, scalability and security.', dates: '2013-06-01 → 2016-01-31' },
      { name: 'ACDC', program: 'CIP', desc: 'Advanced Cyber Defence Centre — end-to-end approach for botnet identification, measurement, prevention, detection and mitigation.', dates: '2013-02-01 → 2015-07-31' },
    ],
  },
  {
    year: '2012',
    items: [
      { name: 'INTER-TRUST', program: 'FP7', desc: 'A framework supporting trustworthy applications in heterogeneous networks based on enforcement of interoperable, changing security policies.', dates: '2012-11-01 → 2015-04-30' },
    ],
  },
  {
    year: '2011',
    items: [
      { name: 'SAN', program: 'CELTIC', desc: 'Survivable Ad Hoc Networks — rapidly deployable, self-configurable mobile wireless networks for rescue teams in disaster scenarios.', dates: '2011-11-01 → 2015-10-31' },
    ],
  },
  {
    year: '2010',
    items: [
      { name: 'PIMI', program: 'ANR', desc: 'Personal Information Management through Internet — design environment and deployment platform with electronic trust, service composition and QoS/QoE.', dates: '2010-11-15 → 2013-11-14' },
      { name: 'DIAMONDS', program: 'ITEA-2', desc: 'Systematic, model-based testing and monitoring approaches for security testing — early testing and test automation for highly secure systems.', dates: '2010-10-01 → 2013-03-31' },
      { name: 'MEVICO', program: 'CELTIC', desc: '3GPP LTE network evolution across architecture, mobility, routing, traffic management and engineering, with contributions to standardization.', dates: '2010-05-01 → 2013-04-30' },
    ],
  },
  {
    year: '2008',
    items: [
      { name: 'WebMov', program: 'ANR', desc: 'Design, composition and validation of Web Services through a high-level abstraction view and a SOA-based logical architecture.', dates: '2008-03-01 → 2010-12-31' },
      { name: 'SHIELDS', program: 'FP7', desc: 'Central repository of security vulnerability models enabling development tools to automatically detect and eliminate vulnerabilities.', dates: '2008-01-01 → 2010-06-30' },
    ],
  },
  {
    year: '2006',
    items: [
      { name: 'CARRIOCAS', program: 'FUI', desc: 'Distributed computing on optical internet networks, supported by the System@tic cluster.', dates: '2006-10-01 → 2009-09-30' },
      { name: 'POLITESS', program: 'ANR', desc: 'Security policies for networked information systems — modeling, deployment and testing.', dates: '2006-03-20 → 2009-03-19' },
    ],
  },
  {
    year: '2005',
    items: [
      { name: 'TAROT', program: 'Marie Curie RTN', desc: 'Training And Research On Testing — a Marie Curie Research Training Network on protocol, service and systems testing.', dates: '2005-01-01 → 2008-12-31' },
    ],
  },
  {
    year: '2004',
    items: [
      { name: 'ASK-IT', program: 'FP5', desc: 'Ambient Intelligence System of Agents for Knowledge-based and Integrated Services for Mobility-Impaired users.', dates: '2004-10-01 → 2007-09-30' },
      { name: 'SERAC', program: 'ACI', desc: 'Research on security in Mobile Ad Hoc Networks, funded by the French Ministry of Education and Research.', dates: '2004-09-01 → 2007-08-31' },
    ],
  },
]
...
export const COMMITTEES = [
  {
    year: '2026',
    pc: [
      'ICICNCT 2026 — Intelligent Communication Networks and Computational Techniques',
      'DASET 2026 — Data Analytics for Sustainability',
      'AINOW 2026 — Advances in AI-based Systems',
      'SIMBig 2026 — Information Management and Big Data',
      'CLOUDCOM 2026 — Cloud Computing Technology and Science',
      'ICTSS 2026 — Testing Software and Systems',
      'STAM 2026 — Security Testing and Monitoring',
      'ICSCCST 2026 — Smart Computing, Communication & Secure Technologies',
      'MobiApps 2026 — Mobile Applications',
      'CSR DAISY 2026, CSR 2026, SecSoft 2026, DT4DRS 2026, ICEPP 2026, ENASE 2026, FET 2026, CyMaEn 2026, ASPAI 2026, ICSOFT 2026, IJCNN 2026',
    ],
    organizing: ['CLOUDCOM 2026', 'ICTSS 2026', 'STAM 2026', 'SecSoft 2026'],
    reviews: ['ICSOFT 2026, SecSoft 2026, CSR 2026, ENASE 2026, FET 2026, IJCNN 2026'],
  },
  {
    year: '2025',
    pc: [
      'ISDAM 2025 — Design and Advanced Manufacturing',
      'DASA 2025 — Decision Aid Sciences and Applications',
      'SIBF 2025 — Sustainable Islamic Business and Finance',
      'FPS 2025 — Foundations & Practice of Security',
      '3ICT 2025 — Innovation in Informatics, Computing and Technologies',
      'DATA 2025 — Data Science, Technology and Applications',
      'ICSH 2025, RFM 2025, CSR 2025, STAM 2025, DT4DRS 2025, ICEPP 2025, ICLAMP 2025, IJCDS 2025',
    ],
    organizing: ['STAM 2025'],
    reviews: ['Journal of Network and Computer Applications, Computer Science Journal, FPS 2025, SIBF 2025, Plos One, SoftwareX, DASA 2025, 3ICT 2025, SIMBig 2025, Computers and Security, MASCOTS 2025, AISYS 2025, ICTSS 2025, IWANN 2025, QRS 2025, CSR 2025, Internet of Things Journal'],
  },
  {
    year: '2024',
    evaluation: ['STIC-AmSud 2024 — 19th Call for proposals'],
    pc: [
      'TrustCom 2024 — Trust, Security and Privacy in Computing and Communications',
      'UbiSec 2024 — Ubiquitous Security',
      'CSCML 2024 — Cyber Security, Cryptology and Machine Learning',
      'DASA 2024 — Decision Aid Sciences and Applications',
      'CloudCom 2024 — Cloud Computing Technology and Science',
      'APACE 2024, GRAAL4IoT 2024, 3ICT 2024, DATA 2024, AISyS 2024, ICSH 2024, ATNT 2024, SpliTech 2024, STAM 2024, ICEPP 2024, ASPAI 2024, ICETSIS 2024',
    ],
    organizing: ['GRAAL4IoT 2024', 'STAM 2024'],
    reviews: ['Internet of Things Journal, UbiSec 2024, DASA 2024, CloudCom 2024, Information and Software Technology, Computers and Security, 3ICT 2024, AISYS 2024, CSCML 2024, ICSH 2024, QRS 2024, Electronics 2024, ITEQS 2024'],
  },
  {
    year: '2023',
    evaluation: ['STIC-AmSud 2023 — 18th Call for proposals'],
    pc: [
      'TrustCom 2023, UbiSec 2023, SpaCCS 2023, SCC 2023, CloudCom 2023',
      '3ICT 2023, ISAP 2023, ICTSS 2023, DATA 2023, STAM 2023, ICSH 2023, Sensors 2023, SecDevOps 2023, JICTRA 2023, DASA 2023, CyMaEn 2023, ASPAI 2023, IJCDS 2023',
    ],
    organizing: ['SCC 2023', 'STAM 2023', 'Sensors 2023', 'SecDevOps 2023'],
    reviews: ['Applied Sciences MDPI, SCC 2023, SPaCCS 2023, ICTSS 2023, STAM 2023, QRS 2023, Applied Software, Computer Journal, Mathematics MDPI, Electronics 2023, Computer Standards & Interfaces, Future Internet, Commag 2023, CyMaEn 2023'],
  },
  {
    year: '2022',
    evaluation: ['STIC-AmSud 2022 — 17th Call for proposals'],
    pc: [
      'TrustCom 2022, UbiSec 2022, SPIoT 2022, ICSEA 2022, SRC 2022',
      'QUATIC 2022, ICTSS 2022, DATA 2022, RFM 2022, ICDSIS 2022, Electronics 2022, DASA 2022, ASPAI 2022, COMNET 2022, IJCDS 2022, ITEQS 2022',
    ],
    reviews: ['STV 2022, UbiSec 2022, Information Sciences Journal, SPIoT 2022, RFM 2022, TrustCom 2022, Electronics Journal, SITIS 2022, ASPAI 2022, QUATIC 2022, COMNET 2022, ITEQS 2022, Computer Networks Journal'],
  },
  {
    year: '2021',
    evaluation: ['STIC-AmSud 2021 — 16th Call for proposals'],
    pc: [
      'TrustCom 2021, UbiSec 2021, ISAIC 2021, SPIoT 2021, QRS 2021',
      'SRC 2021, TMPA 2021, ICTSS 2021, QUATIC 2021, BSC 2021, Computer Networks Journal, DATA 2021, AWPT 2021, ARES 2021, SME-SP 2021, 3ICT 2021, FITEE 2021, Sustainability Journal, Electronics 2021, Computer Standards & Interfaces, ASPAI 2021, Information Sciences, IJCDS 2021',
    ],
    organizing: ['SME-SP 2021', 'Electronics 2021'],
    reviews: ['FPS 2021, QRS 2021, SME-SP 2021, ICTSS 2021, FITEE 2021, Sustainability, IJCDS 2021, ICWS 2021, QUATIC 2021, IM 2021'],
  },
  {
    year: '2020',
    evaluation: ['STIC-AmSud 2020 — 15th Call for proposals'],
    pc: [
      'Internet of Things Journal, TrustCom 2020, SPIoT 2020, SpaCCS 2020, Software Quality Journal, CLSB 2020',
      'SRC 2020, CRISIS 2020, ICWS 2020, BSC 2020, RFM 2020, DATA 2020, 3ICT 2020, ECONF 2020, Computers and Security, SCS 2020, ASPAI 2020, TOMM 2020, Information Sciences, IJGUC 2020, QUATIC 2020, IJCDS 2020',
    ],
    reviews: ['SQJO 2020, IJCDS 2020, FPS 2020, SpaCCS 2020, Information Sciences, Data 2020, SPIoT 2020, RFM 2020, TrustCom 2020, CRISIS 2020, WiMob 2020, STV 2020, ICWS 2020, TOMM 2020, QUATIC 2020, QRS 2020, BSC 2020, ECONF 2020, Computer Networks'],
  },
  {
    year: '2019',
    evaluation: ['STIC-AmSud 2019 — 14th Call for proposals', 'NSERC 2019 — Natural Sciences and Engineering Research Council of Canada'],
    pc: ['SPIoT 2019, APACE 2019, FPS 2019, AIECon 2019, QUATIC 2019, ICSOFT 2019, ANT 2019, SCS 2019, SFECS, SAC 2019, ASPAI 2019, CSAE 2019'],
    reviews: ['FPS 2019, CSAE 2019, Transactions on Cyber-Physical Systems, WiMob 2019, ICTSS 2019, QUATIC 2019, STAF-RPS 2019, ICSOFT 2019, SPIoT 2019, ASPAI 2019, ANT 2019, QRS 2019, ICWS 2019, IoT Journal, SAC 2019'],
  },
  {
    year: '2018',
    evaluation: ['NSERC 2018'],
    pc: ['SpaCCS 2018, SPIoT 2018, IWCSS 2018, ATC 2018, QUATIC 2018, MobiApps 2018, ANT 2018, SCS 2018, WOMRAC 2018, Information Science Journal, DPNoC 2018, SISTECH 2018, WORCAS 2018, AVAREIT 2018, FITEE Journal, IJCDS, AIECon 2018'],
    reviews: ['Software Quality Journal, SPIoT 2018, Saconet 2018, Information Science, JKSU CIS, Computer Standards & Interfaces, ICSOFT 2018, QRS 2018, SCS 2018, IJCDS V7, AVAREIT 2018, SISTECH 2018, WORCAS 2018'],
  },
  {
    year: '2017',
    pc: ['FITEE Journal, ICIIT 2017, SPIoT 2017, SpaCCS 2017, APMC 2017, AIECon 2017, ISWTA 2017, MCS 2017, MobiApps 2017, CS-HSC 2017, SCCCS 2017, Securware 2017, ANT 2017, GCC 2017, INFOCOM NOM 2017, DPNoC 2017, IEACon 2017, Information Science Journal, IJCDS Journal'],
    organizing: ['STAM 2017 (cancelled)'],
    reviews: ['FITEE, SPIoT 2017, Information Sciences, IEEE Transactions on Reliability, INS-Journal, ICIIT 2017, IJCDS-2017, SpaCCS 2017, IJCDS 2017, APMC 2017, SCCCS 2017, IJCDS V6, ICWS 2017, DPNoC 2017, INFOCOM NOM 2017, GCC 2017'],
  },
  {
    year: '2016',
    evaluation: ['STIC-AmSud 2016 — 11th Call for proposals'],
    pc: ['APACE 2016, IPAC 2016, IEACon 2016, SpaCCS 2016, BDAW 2016, GCC 2016, ICTSS 2016, CyberC 2016, SpaIoT 2016, WoTBD 2016, MCS 2016, MobiApps 2016, DPNoC 2016, Securware 2016, STAM 2016, JASC Journal, IJCDS Journal'],
    organizing: ['STAM 2016'],
    reviews: ['APACE 2016, BDAW 2016, IEACon 2016, SpaCCS 2016, CyberC 2016, ICTSS 2016, ASOC, FM 2016, QRS 2016, Securware 2016, JASC, ICWS 2016'],
  },
  {
    year: '2015',
    evaluation: ['STIC-AmSud 2015 — 10th Call for proposals'],
    pc: ['ISSPIT 2015, Securware 2015, ICACOMIT 2015, WoTBD 2015, MSC 2015, SpaIoT 2015, STAM 2015, MobiApps 2015, ICTSS 2015, IJCDS Journal, DPNoC 2015, STDJ 2015, AASCIT Journals'],
    organizing: ['STAM 2015'],
    reviews: ['ISSPIT 2015, MCS 2015, ICTSS 2015, JSS-D-14, Securware 2015, ICWS 2015'],
  },
  {
    year: '2014',
    pc: ['JSS-D 2014, SDTA 2014, Secureware 2014, ISWTA 2014, ISIEA 2014, SpaIoT 2014, ICTSS 2014, DPNoS 2014, MAIS 2014, JSC-SCSS, SECTEST 2014, MobiApps 2014, ISCAIE 2014, Computer Journal, ICEPIT 2014, IJCDS Journal'],
    reviews: ['JSS-D-14, SDTA 2014, SpaIoT 2014, ISIEA 2014, ICTSS 2014, ISWTA 2014, JSC-SCSS13, SECTEST 2014, Computer Journal, ICWS 2014, HASE 2014, ISCAIE 2014, IJCDS'],
  },
  {
    year: '2013',
    pc: ['Computer Journal, IJCDS, UCAAT 2013, ISWTA 2013, ACS 2013, SETOP 2013, ISCI 2013, SECTEST 2013'],
    organizing: ['SECTEST 2013'],
    reviews: ['Computer Journal — Oxford Journals, ISWTA 2013, ACS 2013, SETOP 2013, ICWS 2013, UCAAT 2013, ISCI 2013, SECTEST 2013'],
  },
  {
    year: '2012',
    pc: ['ICCSII 2012, ISWTA 2012, ACS 2012, SECTEST 2012'],
    organizing: ['SECTEST 2012'],
    reviews: ['Journal of Systems and Software, Journal of Network and Computer Applications, SoftCom 2012, ACS 2012, ICWS 2012, ISWTA 2012, SECTEST 2012'],
  },
  {
    year: '2011',
    pc: ['ACS 2011, SECTEST 2011'],
    organizing: ['SECTEST 2011'],
    reviews: ['ACS 2011, ICNP 2011, Behavior and Information Technology Journal, ICWS 2011, SECTEST 2011'],
  },
  {
    year: '2010',
    pc: ['SETOP 2010, RTSOABIS 2010, MDV 2010'],
    organizing: ['SETOP 2010', 'TSEE 2010', 'MDV 2010'],
    reviews: ['SETOP 2010, TSEE 2010, RTSOABIS 2010, NOTERE 2010, MDV 2010'],
  },
  {
    year: '2009',
    pc: ['NTSM 2009'],
    organizing: ['NTSM 2009'],
    reviews: ['ICFEM 2009, SoftCom 2009, NTSM 2009'],
  },
  {
    year: '2008',
    reviews: ['International Journal of Network Security, SITIS 2008, ICNP 2008, QEES 2008, TestCom 2008, CFIP 2008, ICST 2008, SecSE 2008'],
  },
  {
    year: '2007',
    reviews: ['SITIS 2007, IJ Computer & Telecommunications Networking, ICNP 2007, ARIMA Journal, ROSATEA 2007, FORTE 2007, TestCom 2007, NOTERE 2007, SAC 2007'],
  },
  {
    year: '2006',
    reviews: ['ICNP 2006, FATES/RV 2006, CFIP 2006, FORTE 2006, Software Testing Verification & Reliability, Annales de Télécommunications, FMUIT 2006, IJ Computer & Telecommunications Networking, ASWN 2006, ICDCS 2006, TestCom 2006'],
  },
  {
    year: '2005',
    reviews: ['IJ Computer & Telecommunications Networking, Software Testing Verification & Reliability'],
  },
]
